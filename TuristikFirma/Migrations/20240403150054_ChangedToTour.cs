...
{
    /// <inheritdoc />
    public partial class ChangedToTour : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleKz = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TitleRu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DescriptionEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DescriptionKz = table.Column<string>(type: "nvarchar(max)", nullable: false),
